...
def generate_launch_description():
    ...
    ####### DATA INPUT ##########
    urdf_file = 'ur10_robot.urdf'
    xacro_file = "ur10_robot.urdf.xacro"
    #xacro_file = "box_bot.xacro"
    package_description = "warehouse_robot"
    use_urdf = False
    ...
    default_rviz_config_path = PathJoinSubstitution(
        [FindPackageShare("warehouse_robot"), "rviz", "display_default.rviz"]
    )

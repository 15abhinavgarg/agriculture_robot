...
def generate_launch_description():
    ...
    ####### DATA INPUT ##########
    urdf_file = 'agriculture_robot.urdf.xacro'
    xacro_file = "agriculture_robot.urdf.xacro"
    #xacro_file = "box_bot.xacro"
    package_description = "agriculture_robot"
    use_urdf = False
    ...
    default_rviz_config_path = PathJoinSubstitution(
        [FindPackageShare("agriculture_robot"), "rviz", "display_default.rviz"]
    )
